...
const API_URL =  'https://www.teepublic.com/search/autocomplete';
  ...
  <ul>
    {
      suggestions.map((s, i) => (
        ...
        <ParticleEffectButton type="rectangle" color="#43E8D8" speed={4} hidden={clicked === null ? false : clicked !== i}> 
        <Ripples onClick={() => {
          setClicked(i)
          setTimeout(() => {
            window.open(`https://www.teepublic.com/t-shirts?${s.type}=${s.suggestion.replace(/ /g, '-')}`, '_blank').focus()
          }, 1250)
